"""
Simulator of the simple intersection featuring a priority system for buses.
"""
...
class PrioritySimulator:
    ...
    <route id="route11" edges="in_south out_east"/>""", file=routes)
            ...
            if hourly_probs:
                ...
                for i in range(self.n):
                    # Generation of buses for the different buslines
    ...
    def generate_bus_depart_times(self, freq, stddev):
        ...
        :param freq: passage frequency
        :param stddev: standard deviation on the planned passage times
        :return: the depart times
        """
        depart_times = []
    ...
    def count_detected_veh(self, ids):
        """
        Counts the number of detected vehicles in each lane.
